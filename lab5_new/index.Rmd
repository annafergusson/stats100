...
In this lab, you will learn how to scrape data from a website and some of the ways you can analyse text, using the <a href="https://www.theta.co.nz/news-blogs/tech-blog/what-is-r/" target="blank">programming language R</a>.
...
> Change the URL to the song lyrics you want to use. Then see if you can remember how to use the `glue()` function from Lab 3 to create informative sentences describing the song you are analysing! 
